jQuery("#simulation")
  .on("click", ".s-0cdc0f1f-b5f6-456e-95d1-1a9a12338089 .click", function(event, data) {
  ...
  .on("pageload", ".s-0cdc0f1f-b5f6-456e-95d1-1a9a12338089 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("focusin", ".s-0cdc0f1f-b5f6-456e-95d1-1a9a12338089 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
