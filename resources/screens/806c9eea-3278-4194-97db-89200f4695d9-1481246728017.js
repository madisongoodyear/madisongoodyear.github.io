jQuery("#simulation")
  .on("click", ".s-806c9eea-3278-4194-97db-89200f4695d9 .click", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
    if(jFirer.is("#s-806c9eea-3278-4194-97db-89200f4695d9")) {
      cases = [
        {
          "blocks": [
            {
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-806c9eea-3278-4194-97db-89200f4695d9 #s-Image_6 > svg": {
                      "attributes": {
                        "overlay": "none"
                      }
                    }
                  },{
                    "#s-806c9eea-3278-4194-97db-89200f4695d9 #s-Image_6": {
                      "attributes": {
                        "opacity": "0.3"
                      }
                    }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-806c9eea-3278-4194-97db-89200f4695d9 #s-Label_39": {
                      "attributes": {
                ...
                },
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-806c9eea-3278-4194-97db-89200f4695d9 #s-Triangle_2 .shapert-clipping": {
                      "attributes": {
                        "left": "0px",
                        "top": "0px",
                        "width": "15px",
                    ...
                    "#s-806c9eea-3278-4194-97db-89200f4695d9 #s-Triangle_2 .content": {
                      "attributes": {
                        "width": "15px",
                        "height": "9px"
                      }
                    ...
                    "#s-806c9eea-3278-4194-97db-89200f4695d9 #s-Triangle_2": {
                      "attributes": {
                        "background-color": "#666666",
                        "background-image": "none"
                      }
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-806c9eea-3278-4194-97db-89200f4695d9 #s-Label_48": {
                      "attributes": {
                        "background-color": "#666666",
                        "background-image": "none",
                        "border-top-width": "1px",
              ...
              "actions": [
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-806c9eea-3278-4194-97db-89200f4695d9 #s-Label_47": {
                      "attributes": {
                        "background-color": "#666666",
                        "background-image": "none",
                        "border-top-width": "1px",
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/0cdc0f1f-b5f6-456e-95d1-1a9a12338089"
                  },
                  "exectype": "serial",
                  "delay": 0
                }
  ...
  .on("click", ".s-806c9eea-3278-4194-97db-89200f4695d9 .toggle", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
                ...
                "actions": [
                  {
                    "action": "jimChangeStyle",
                    "parameter": [ {
                      "#s-806c9eea-3278-4194-97db-89200f4695d9 #s-Label_34": {
                        "attributes": {
                          "background-color": "#666666",
                          "background-image": "none",
                          "border-top-width": "1px",
  ...
  .on("focusin", ".s-806c9eea-3278-4194-97db-89200f4695d9 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("variablechange.jim", ".s-806c9eea-3278-4194-97db-89200f4695d9 .variablechange", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
