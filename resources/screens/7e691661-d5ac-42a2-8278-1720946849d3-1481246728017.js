jQuery("#simulation")
  .on("click", ".s-7e691661-d5ac-42a2-8278-1720946849d3 .click", function(event, data) {
  ...
  .on("pageload", ".s-7e691661-d5ac-42a2-8278-1720946849d3 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("focusin", ".s-7e691661-d5ac-42a2-8278-1720946849d3 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
